...
def load_models():
    ...
    xray_path = hf_hub_download(repo_id=HF_REPO, filename=XRAY_FILE)
    ct_path = hf_hub_download(repo_id=HF_REPO, filename=CT_FILE)
    mri_path = hf_hub_download(repo_id=HF_REPO, filename=MRI_FILE)
